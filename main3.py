...
from json_generator.processing.issue_processing.issue_type import get_issues_by_category
            ...
            for project in result["projects"]:
                ...
                for branch in project.branches : 
                    ...
                    if branch.issues: 
                        ...
                        details_category=get_issues_by_category(detailled_issues,"Bug")
                        print("********************************")
                        print(details_category)
